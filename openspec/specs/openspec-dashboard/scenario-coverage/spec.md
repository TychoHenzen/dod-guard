...
The spec detail endpoint SHALL include a coverage map alongside the existing scenario data. The map SHALL be keyed by scenario id, and each entry SHALL carry the test file path and the test name.
