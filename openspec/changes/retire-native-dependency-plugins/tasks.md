...
- [ ] 7.1 Push and confirm CI is green before anything leaves the machine. `git-only-plugin-distribution` proved this order matters: its own section 5 was blocked because npm was still the only working path for the three plugins this change deletes.
