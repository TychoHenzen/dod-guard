...
import { assertSupportedGitVersion, collectBoundedGitOutput, discoverGitRepository, parseGitVersion, readHistoryWithSupportedGit, } from "./git-process.js";
function pipedChild() {
...
function repositoryDiscoveryArguments(repositoryPath) {
    return [
        "--no-pager",
        "-c",
