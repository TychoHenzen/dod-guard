...
import { benchmarkPerformanceFixture, fastImportStream, MAXIMUM_PERFORMANCE_DURATION_MS, performanceBenchmarkJson, TARGET_PERFORMANCE_FIXTURE, } from "./performance.js";
...
async function assertExceededBenchmark() {
    await assert.rejects(benchmarkPerformanceFixture({
        root: "C:/fixture",
        ...TARGET_PERFORMANCE_FIXTURE,
        cleanup: async () => undefined,
    }, {
...
test("defines the target fixture and enforces three fresh JSON analysis runs " +
    "below ten seconds", async () => {
