...
test("ranks close change points deterministically and recursively splits both " +
    "sides", () => {
    ...
    const recursiveFileSets = Array.from({ length: 6 }, (_, group) => Array.from({ length: 5 }, () => [
        `group-${group}-a.ts`,
        `group-${group}-b.ts`,
        `group-${group}-c.ts`,
    ])).flat();
...
//# sourceMappingURL=git-history-recursive.cases.js.map