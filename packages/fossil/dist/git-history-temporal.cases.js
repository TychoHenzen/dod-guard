...
test("splits chronological commits when an adjacent gap is one millisecond " +
    "above the threshold", () => {
    const commits = [
...
test("keeps chronological commits together when their adjacent gap equals the " +
    "threshold", () => {
...
//# sourceMappingURL=git-history-temporal.cases.js.map