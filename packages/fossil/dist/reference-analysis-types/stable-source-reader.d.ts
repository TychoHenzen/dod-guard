...
export type StableReferenceSourceReader = (source: ReferenceCandidate, maximumBytes: number, expected: ReferenceSourceSnapshot) => string | StableReferenceSourceRead;
