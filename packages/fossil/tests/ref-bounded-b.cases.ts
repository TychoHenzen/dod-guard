...
import { readBoundedReferenceSources } from "../src/ref-analyzer.js";

test(
  "stops all later source reads when the total content budget is reached or " +
    "exceeded",
  () => {
