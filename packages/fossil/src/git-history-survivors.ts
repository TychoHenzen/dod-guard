...
export function selectAbsoluteSurvivors(
  files: readonly BurstFileActivity[],
): BurstFileActivity[] {
...
export function selectRelativeSurvivors(
  files: readonly BurstFileActivity[],
): BurstFileActivity[] {
...
export function selectDeletedNonSurvivorPaths(
  files: readonly BurstFileActivity[],
): string[] {
  const survivors = new Set(selectSurvivors(files));
  return files
