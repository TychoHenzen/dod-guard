...
| `skill-migrate` | Migrate a skill to post-4.6 models. Analyzes inference gaps, generates sandbox-based eval cases, benchmarks before and after migration transforms, and gates on 4.6 compatibility |
