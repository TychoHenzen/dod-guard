...
import { checkReachability } from "../../../../../skills/quality-refactor/scripts/lib/rules-project.mjs";
...
test("a Rust pub fn read only from another file's format capture is reachable", () => {
  const files = [
    rustFile(
      "src/stats.rs",
      "pub fn tally(items: &[u32]) -> u32 { items.iter().sum() }",
