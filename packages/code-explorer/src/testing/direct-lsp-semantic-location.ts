  ...
  return semanticClient(
    async (method: string) =>
      method === "textDocument/definition"
        ...
        : [{ uri: "file:///project/src/main.rs", range: { start: { line: 0, character: 0 }, end: { line: 0, character: 1 } } }],
    { definitionProvider: true, referencesProvider: true },
  );
}
...
export function externalLocationClient() {
  return semanticClient(
    async () => [{ uri: "file:///outside/lib.rs", range: { start: { line: 0, character: 0 }, end: { line: 0, character: 1 } } }],
    { definitionProvider: true },
  );
}

export function assertOpenedTwice(opened: Array<{ uri: string; content: unknown }>): void {
