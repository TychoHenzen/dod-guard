...
import { RootAccessGate } from "../../src/semantic/project-root/root-access.js";
import {
  adapter,
  root,
} from "../testing/project-root/root-access-test-support.js";

it("makes a changed or missing root status-only and stops", async () => {
  const calls: string[] = [];
...
it("restarts selected backends after root recovery", async () => {
