...
import { createBackendStatusReport } from "../../src/semantic/backend-status/backend-status.js";
import { createNativeProjectRoot } from "../../src/semantic/project-root/project-root.js";
import { createRuntimeAdapters } from "../../src/semantic/runtime/runtime-bootstrap.js";

it("exposes one fail-closed status for \
every selected production language", () => {
