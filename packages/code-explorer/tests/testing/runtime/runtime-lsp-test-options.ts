import type { LspProcess } from "../../../src/semantic/direct-lsp/direct-lsp.js";
import type { RuntimeLspBackendOptions } from "../../../src/semantic/runtime/runtime-lsp-backend.js";
import {
  readyPreparation,
  runtimeRoot,
