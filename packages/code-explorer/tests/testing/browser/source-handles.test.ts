...
import { sourceHandles } from "../../../src/browser/source-handles.js";

describe("source handles", () => {
  it(
    "maps repeated names to " + "ordered, non-overlapping source spans",
    () => {
  ...
  it(
    "uses package-owned offsets and " +
      "ignores malformed or out-of-range candidates",
    () => {
      assert.deepEqual(
        sourceHandles(
          {
