...
import { renderFocusedSource } from "../../../src/browser/source.js";
import { sourceFixture } from "./fixtures/source.test.js";

describe("focused source", () => {
  it(
    "renders UTF-16 validated " + "handles as view-owned selectable text",
    () => {
