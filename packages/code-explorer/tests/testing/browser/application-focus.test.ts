...
import { ApplicationFocusController } from "../../../src/browser/application-focus.js";
import { BrowserFocusNavigation } from "../../../src/browser/focus-navigation.js";
import { BrowserRelationView } from "../../../src/browser/relations.js";
...
describe("application focus controller", () => {
  it("reports ready after focusing a symbol", async () => {
    ...
    try {
      ...
      await new ApplicationFocusController(
        navigation,
        relationView,
      ).focusSymbol("symbol-main");
