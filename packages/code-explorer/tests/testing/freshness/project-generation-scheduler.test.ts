...
import * as generations from "../../../src/freshness/project-generation-scheduler.js";
import {
  type ReconcileResult,
  WorkspaceFreshness,
} from "../../../src/freshness/workspace-freshness.js";
...
it(
  "coalesces concurrent session refreshes into one globally " +
    "ordered publication",
  async () => {
...
it(
  "captures current and pending generations in FIFO " +
